...
public class UsuarioService {
	...
	public Optional<UsuarioModel> cadastrarUsuario(UsuarioModel usuario) { // Método de cadastro de usuário.
	...
	private String criptografarSenha(String senha) { // Método de apoio p/ criptografar a senha.
	...
	public Optional<UsuarioModel> atualizarUsuario(UsuarioModel usuario) { // Método p/ atualizar usuário.
